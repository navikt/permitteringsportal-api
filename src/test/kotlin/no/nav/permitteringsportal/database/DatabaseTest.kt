...
class DatabaseTest {
    ...
    fun `Skal kunne skrive og lese fra database`() {
        ...
        repository.leggTilNyBekreftelse("11111111111", "111111111", "NY",100, Date(), Date());
    ...
    fun `Skal kunne lagre flere hendelser på en bekreftelse`() {
        ...
        val bekreftelseId = repository.leggTilNyBekreftelse("11111111111", "111111111", "NY", 100, Date(), Date());
        val hendelseId =
        ...
        assertEquals(hentAlleHendelser.size, 3)
